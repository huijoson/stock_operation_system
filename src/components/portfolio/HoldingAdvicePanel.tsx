  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900">持股建議</h3>
        <AdviceTypeBadge adviceType={adviceType} confidence={confidence} />
      </div>

      <div className="space-y-4">
        <div>
          <h4 className="text-sm font-medium text-gray-700 mb-2">建議理由</h4>
        ...
        <div className="pt-4 border-t border-gray-200">
          <div className="flex items-center justify-between text-sm">
            <span className="text-gray-500">
              信心度: <span className="font-semibold text-gray-900">{confidence}%</span>
            </span>
            <span className="text-gray-500">
              更新時間:{' '}
