...
### 投資組合洞察 ✨
- **已實現損益計算** - 採用 FIFO（先進先出）方法自動計算賣出交易的損益
- **技術分析風險評估** - 整合 RSI、MACD、布林通道、費波那契等技術指標評估持股風險
- **持股操作建議** - 基於風險評估與技術分析提供減碼/持有/加碼建議
- **新聞整合與情緒分析** - 整合外部新聞 API，並結合情緒分析納入風險評估
- **視覺化圖表** - 損益分布、持股佔比、技術指標等多種互動式圖表
